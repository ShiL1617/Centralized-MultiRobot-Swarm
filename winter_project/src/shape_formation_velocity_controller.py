...
# N arrangement
# GOAL_POSES = np.array([[-2.5,-2.,0.],[-2.5,-1.5,0.],[-2.5,-1.,0.],[-2.5,-0.5,0.],[-2.5,0.,0.],[-2.5,0.5,0.],[-2.5,1.0,0.],[-2.5,1.5,0.],[-2.5,2.0,0.],[-2.5,2.5,0.],[-2.,2.0,0.],[-1.5,1.5,0.],[-1.,1.0,0.],[-0.5,0.5,0.],[0.,0.,0.],[0.5,-0.5,0.],[1.,-1.,0.],[1.5,-1.5,0.],[2.0,-2.0,0.],[2.5,-2.5,0.],[2.5,-2.0,0.],[2.5,-1.5,0.],[2.5,-1.0,0.],[2.5,-0.5,0.],[2.5,0.,0.],[2.5,0.5,0.],[2.5,1.0,0.],[2.5,1.5,0.],[2.5,2.0,0.],[2.5,2.5,0.]])

# U arrangement
GOAL_POSES = np.array([[-2.5,2.5,0.],[-2.5,2.,0.],[-2.5,1.5,0.],[-2.5,1.0,0.],[-2.5,0.5,0.],[-2.5,0.,0.],[-2.5,-0.5,0.],[-2.5,-1.,0.],[-2.5,-1.5,0.],[-2.25,-2.0,0.],[-2.0,-2.5,0.],[-1.5,-3.0,0.],[-1.0,-3.25,0.],[-0.5,-3.5,0.],[0.,-3.5,0.],[0.5,-3.5,0.],[1.0,-3.25,0.],[1.5,-3.0,0.],[2.0,-2.5,0.],[2.25,-2.,0.],[2.5,-1.5,0.],[2.5,-1.0,0.],[2.5,-0.5,0.],[2.5,0.,0.],[2.5,0.5,0.],[2.5,1.0,0.],[2.5,1.5,0.],[2.5,2.0,0.],[2.5,2.5,0.],[2.5,3.0,0.]])
    ...
    def pos_array_callback(self, tdata):
        ...
        for i in range(N):
            ...
            if abs(a_first) > (pi/50.) and abs(linear_error)>0.01:
                ...
                current_x_max = pose_predict[0] + self.bot_box_length
                current_x_min = pose_predict[0] - self.bot_box_length
                current_y_max = pose_predict[1] + self.bot_box_length
                current_y_min = pose_predict[1] - self.bot_box_length
...
def main():
    rospy.init_node('formation_diff_drive_velocity_controller')
